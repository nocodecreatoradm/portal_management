      ...
      const updated = shipments.map(s => {
        if (s.id === editingShipmentId) {
          return {
            ...
            quoteName: newShipment.quoteName,
            quoteUrl: newShipment.quoteUrl,
